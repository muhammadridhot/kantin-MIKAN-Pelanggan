...
public class stan_adapter_kantina extends RecyclerView.Adapter<stan_adapter_kantina.ViewHolder> {
    ...
    public stan_adapter_kantina(Context context, List<Penyewa> stan, OnItemClickListener onItemClickListener) {
        this.ctx = context;
        this.dataStan = stan;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewHolder(LayoutInflater.from(ctx).inflate(R.layout.tampilan_stan_kantina,viewGroup,false));
    }
